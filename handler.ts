...
const UNDERAGE_CONTENT_REGEX = /\b(child|children|teenager|teenagers|teen|underage|minors?|infant|toddler|preadolescent|young adult|juvenile|baby|babies|preteen|adolescent|0[\s-]?(year[\s-]?old|y[\s/]o)|1[\s-]?(year[\s-]?old|y[\s/]o)|2[\s-]?(year[\s-]?old|y[\s/]o)|3[\s-]?(year[\s-]?old|y[\s/]o)|4[\s-]?(year[\s-]?old|y[\s/]o)|5[\s-]?(year[\s-]?old|y[\s/]o)|6[\s-]?(year[\s-]?old|y[\s/]o)|7[\s-]?(year[\s-]?old|y[\s/]o)|8[\s-]?(year[\s-]?old|y[\s/]o)|9[\s-]?(year[\s-]?old|y[\s/]o)|10[\s-]?(year[\s-]?old|y[\s/]o)|11[\s-]?(year[\s-]?old|y[\s/]o)|12[\s-]?(year[\s-]?old|y[\s/]o)|13[\s-]?(year[\s-]?old|y[\s/]o)|14[\s-]?(year[\s-]?old|y[\s/]o)|15[\s-]?(year[\s-]?old|y[\s/]o)|16[\s-]?(year[\s-]?old|y[\s/]o)|17[\s-]?(year[\s-]?old|y[\s/]o))\b/i;
